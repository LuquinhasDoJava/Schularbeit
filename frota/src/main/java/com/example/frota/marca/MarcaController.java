...
public class MarcaController {
    ...
    @PostMapping("/salvar")
    public String salvar(@ModelAttribute("marca") @Valid AtualizacaoMarca dto,
    ...
    @Transactional
    public String deleteMarca(@PathVariable("id") Long id, RedirectAttributes redirectAttributes) {
        try {
